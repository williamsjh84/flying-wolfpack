...
export const metadata: Metadata = {
  title: "Journal",
  description: "Long-form writing from the road. Travel essays, destination deep-dives, and honest reflections on family travel.",
};
              ...
              <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
                ...
                <div>
                  <p className="font-sans text-xs tracking-widest text-earth uppercase">
                    {featured.category} · {formatDate(featured.date)} · {featured.readTime} read
                  </p>
                  <h2 className="mt-3 font-serif text-3xl font-bold italic leading-tight text-ink transition-colors group-hover:text-ocean sm:text-4xl">
                    {featured.title}
                  </h2>
                  <p className="mt-4 font-sans text-base leading-relaxed text-ink/60">
                    {featured.excerpt}
                  </p>
                  <p className="mt-6 font-sans text-sm tracking-widest text-earth uppercase group-hover:text-ink transition-colors">
                    Read →
                  </p>
                </div>
              </div>
